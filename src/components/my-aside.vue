      ...
      submit(text,tag){
        ...
        switch (text) {
          case '文本':
            ...
            this.$store.dispatch('changeStandardList',["color","fontsize","fontstyle","backgroundcolor","border","filter","padding","textshadow","boxshadow","transition","transform","outline"]);
